...
## Karta raqami
`.env` fayliga `PAYMENT_CARD_NUMBER` va `PAYMENT_CARD_OWNER` qo'shing — bular mijozlarga
band qilish/buyurtma sahifasida va tasdiqlash xabarida ko'rsatiladi.

## Bosh sahifadagi "Hozirgi holat"
Har bir klub va ijara konsolining shu daqiqadagi holati (🟢 bo'sh / 🔴 band) bosh sahifada
avtomatik ko'rinadi.
